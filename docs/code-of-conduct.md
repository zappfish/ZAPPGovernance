...
All members of the ZAPP community will be expected to abide by the highest research ethical standards in accordance with the Online Ethics Center for Engineering and Science, [Moore (2011)](https://onlineethics.org/), and the AI code of ethics (https://futureoflife.org/ai-principles/). Plagiarism and data fabrication will not be allowed. These and other ethics violations will be reported.
...
This code of conduct is based on the Open Code of Conduct from the [TODO Group](https://todogroup.org/), Code of Conduct from the [Galaxy Community Conference 2019](https://galaxyproject.org/), and Code of Conduct from [GenoPhenoEnvo Governance and Operations Manual](https://genophenoenvo.github.io/).
